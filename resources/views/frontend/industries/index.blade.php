    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('industries.show', $industry->slug) }}"
               class="group card-glass rounded-2xl p-6 transition-all duration-300 text-center">
                ...
                <h3 class="font-semibold text-white group-hover:text-brown-300 transition-colors mb-2">{{ $industry->name }}</h3>
