...
<section class="bg-navy-900 relative overflow-hidden texture py-28">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <x-breadcrumbs :items="[['name'=>'Services']]"/>
        <div class="mt-8">
            <p class="text-xs font-semibold uppercase tracking-widest text-teal-400 mb-4">What We Do</p>
            <h1 class="text-5xl md:text-6xl font-heading text-white leading-tight mb-4">Engineering <em class="font-display not-italic text-brown-300">Services</em></h1>
            ...
            <a href="{{ route('services.show', $service->slug) }}"
               ...
               style="transition-delay: {{ $i * 60 }}ms">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-slate-50">
                    <span class="text-xs font-semibold text-teal-600 uppercase tracking-wide">Explore Service</span>
...
<section class="py-16 bg-navy-900 texture relative overflow-hidden">
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
        ...
        <p class="text-slate-400 mb-8">Our multi-disciplinary teams combine services across engineering disciplines to deliver seamless, end-to-end project delivery.</p>
