...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-xl font-heading font-bold text-gray-900">Services</h2>
    <a href="{{ route('admin.services.create') }}" class="bg-teal-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-teal-700">+ New Service</a>
</div>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.services.edit', $service->id) }}" class="text-xs text-teal-600 hover:text-navy-800 font-medium">Edit</a>
                        <form method="POST" action="{{ route('admin.services.destroy', $service->id) }}" onsubmit="return confirm('Delete?')">
                            @csrf @method('DELETE')
