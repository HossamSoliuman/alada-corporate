...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-xl font-heading font-bold text-gray-900">Industries</h2>
    <a href="{{ route('admin.industries.create') }}" class="bg-teal-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-teal-700">+ New</a>
</div>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.industries.edit', $industry->id) }}" class="text-xs text-teal-600 hover:text-navy-800 font-medium">Edit</a>
                        <form method="POST" action="{{ route('admin.industries.destroy', $industry->id) }}" onsubmit="return confirm('Delete?')">
                            @csrf @method('DELETE')
...
<div class="mt-5">{{ $industries->links() }}</div>
@endsection
